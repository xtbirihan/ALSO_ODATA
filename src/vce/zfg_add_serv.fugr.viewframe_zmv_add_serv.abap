*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_ADD_SERV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_ADD_SERV        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_ADD_SERV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_ADD_SERV_EXTRACT
TOTAL = ZMV_ADD_SERV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_ADD_SERV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_ADD_SERV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_ADD_SERV_EXTRACT
TOTAL = ZMV_ADD_SERV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_ADD_SERV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_ADD_SERV'
...
TOTAL = ZMV_ADD_SERV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_ADD_SERV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_ADD_SERV-UPD_FLAG NE SPACE.
